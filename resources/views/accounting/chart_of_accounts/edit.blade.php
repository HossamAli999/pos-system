@extends('layouts.app')
@section('title', __('gl.edit_account'))

@section('content')

<section class="content-header">
    <h1>@lang('gl.edit_account')</h1>
</section>

<section class="content">
    {!! Form::open(['url' => action([\App\Http\Controllers\Accounting\ChartOfAccountController::class, 'update'], [$account->id]), 'method' => 'put']) !!}
