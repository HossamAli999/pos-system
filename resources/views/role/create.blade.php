        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'van_sales.access', false,
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'van_sales.manage', false,
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'van_sales.approve', false,
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'audit_log.view', false,
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'approval_workflow.manage', false,
          ...
          <div class="col-md-9">
            @foreach(['employee.view', 'employee.create', 'employee.update', 'employee.delete',
              ...
              <div class="col-md-4">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', $hr_permission, false,
          ...
          <div class="col-md-9">
            @foreach(['crm_lead.view_all', 'crm_lead.view_own', 'crm_lead.create', 'crm_lead.update', 'crm_lead.delete',
              ...
              <div class="col-md-4">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', $crm_permission, false,
          ...
          <div class="col-md-9">
            @foreach(['gl.manage', 'gl.view_reports', 'journal_entry.view', 'journal_entry.create'] as $gl_permission)
              <div class="col-md-4">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', $gl_permission, false,
          ...
          <div class="col-md-9">
            @foreach(['manufacturing.view', 'manufacturing.manage', 'work_order.view', 'work_order.create', 'work_order.complete'] as $mfg_permission)
              <div class="col-md-4">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', $mfg_permission, false,
          ...
          <div class="col-md-9">
            @foreach(['project.view_all', 'project.view_own', 'project.create', 'project.update', 'project.delete'] as $project_permission)
              <div class="col-md-4">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', $project_permission, false,
